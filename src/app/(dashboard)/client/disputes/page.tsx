            ...
            <div className="space-y-4">
                {filteredDisputes.length === 0 ? (
                    ...
                    filteredDisputes.map((dispute) => {
                        ...
                        return (
                            <Link key={dispute.id} href={`/client/disputes/${dispute.id}`}>
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-zinc-500 text-sm">
                                                Contract: {dispute.contractTitle} • With: {otherParty}
                                            </p>
                                    ...
                                    {dispute.outcome && dispute.freelancerPercent !== null && (
                                        <div className="mt-3 pt-3 border-t border-zinc-800">
                                            <p className="text-emerald-400 text-sm">
                                                ✓ Resolved — {dispute.freelancerPercent}% to freelancer, {100 - dispute.freelancerPercent}% refund
                                            </p>
                                        </div>
                                    )}
                                </GlassCard>
