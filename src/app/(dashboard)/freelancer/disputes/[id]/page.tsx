...
export default function FreelancerDisputeDetailPage() {
    ...
    // Sync messages and evidence from server data
    useEffect(() => {
            ...
            <div className="grid grid-cols-[7fr_3fr] gap-6 items-start">
                ...
                <div className="space-y-6">
                    ...
                    {pendingFile && (() => {
                        ...
                        const dupOwnerLabel = isOwnDuplicate ? 'You' : contract.clientName || 'Client';
                        return (
                    ...
                    {dispute.status === 'ADMIN_REVIEW' && (
                        <ArbitrationChat
                            ...
                            isMuted={!!(dispute.freelancerMutedUntil && new Date(dispute.freelancerMutedUntil) > new Date())}
                            mutedUntil={dispute.freelancerMutedUntil ?? null}
