...
export default async function FreelancerTransactionDetailPage({ params }: PageProps) {
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: '#0B0F14' }}>
            <div className="w-full px-6 md:px-8 xl:px-16 py-8 max-w-3xl">
                ...
                <Link href="/freelancer/wallet" className="text-[14px] text-zinc-500 hover:text-zinc-300 transition-colors mb-6 inline-block">
                    ← Back to Wallet
                </Link>
                ...
                <div className="rounded-lg border p-6 space-y-6" style={{ backgroundColor: '#111318', borderColor: '#1E2328' }}>
                    ...
                    <div className="space-y-4">
                        ...
                        {contract && (
                            <Row label="Contract" value={contract.title} link={`/freelancer/contracts/${contract.id}`} />
                        )}
                        {milestone && (
