...
export default async function JobDetailsPage({ params }: JobPageProps) {
    // Await params since it can be a promise in future Next.js versions, 
    // though currently it's an object. 
    // Ideally we just treat it as object for now or await it if strict.
                                    ...
                                    <div className="flex flex-wrap gap-6 text-sm text-white/60 mb-8 pb-8 border-b border-white/5">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-white font-medium">${job.budget.toLocaleString()}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2">
                                    ...
                                    {hasApplied ? (
                                        ...
                                        session ? (
                                            ...
                                            <Link href="/login?role=freelancer" className="block w-full">
                                                <GlassButton className="w-full">Log in to Apply</GlassButton>
                                            </Link>
                                        )
                                    )}
