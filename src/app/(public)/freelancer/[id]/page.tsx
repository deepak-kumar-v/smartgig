...
import {
    ...
    Briefcase, GraduationCap, Award, Link2, MessageSquare,
                        ...
                        <div className="space-y-6">
                            ...
                            <GlassCard className="p-6">
                                <div className="text-center mb-6">
                                    <p className="text-3xl font-bold text-white">${profile.hourlyRate}</p>
                                ...
                                <div className="flex items-center gap-2 text-sm text-emerald-400 justify-center">
                                    ...
                                    Available now • {profile.weeklyHours}h/week
                                </div>
                            </GlassCard>
